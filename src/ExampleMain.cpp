...
int main(int argc, char* argv[]) {
    RocketSim::Init("/home/bugss/Desktop/GigaLearnCPP-Leak/collision_meshes"); //INCLUDE YOUR COLLISION MESHES

    LearnerConfig cfg = {};
    cfg.deviceType = LearnerDeviceType::GPU_CUDA;
    cfg.tickSkip = 8; //tick skip, if you change this you should change gamma
    cfg.actionDelay = cfg.tickSkip - 1;
    cfg.numGames = 380; //adjust to how good your cpu is, mine is a i7-12700k and 192 games is optimal for me. The better your cpu is, the more games you should have.
    ...
    cfg.ppo.sharedHead.layerSizes = { 2048, 2048, 2048}; //your bot has a shared head, both the cpu and critic learn from this, this should be big sizes
